...
Use this before calling a GTM Brain section done.

## Passes

- It says what source types were used and what is still missing.
- It distinguishes `Approved`, `Working theory`, `Evidence`, `Question`, and `Do not claim`.
...
- It reads like generic GTM advice.
- It converts one anecdote into a universal claim.
